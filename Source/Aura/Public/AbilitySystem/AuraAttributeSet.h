...
// Type alias that is a pointer for static functions
...
public:
	...
	*/
	...
	// Strength increases phyiscal damage
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_Strength, Category = "Primary Attributes")
	FGameplayAttributeData Strength;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, Strength);

	// Intelligence increases magical damage and mana
	...
	*/
	...
	// This is how to make an attribute replicated
